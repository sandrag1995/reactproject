import './App.css';
import  "./components/Users1";
import {useState} from "react"
import Users_task5 from "./components/Users_task5";
function task5() {
    ...
    const users = [
        {
            ...
            "company":{
                "address":{
                    ...
                    "city":"Nashville",
                    "coordinates":{
                        "lat":36.208114,"lng":-86.58621199999999
                    },
                    "postalCode":"37076","state":"TN"
                },
                "department":"Marketing",
                "name":"Blanda-O'Keefe","title":"Help Desk Operator"},
            "ein":"20-9487066","ssn":"661-64-2976",
        ...
        },
        {
            ...
            "company":{
                "address":{
                    ...
                    "city":"Arvada",
                    "coordinates":{
                        "lat":39.8267078,"lng":-105.1366798
                    },
                    "postalCode":"80004",
                    "state":"CO"
                },
        ...
        },
        {
            ...
            "company":{
                ...
                "department":"Research and Development","name":"Steuber, Considine and Padberg",
        ...
        },
        {
            ...
            "address":{
                ...
                "city":"Montgomery",
                "coordinates":{
                    "lat":32.341227,"lng":-86.2846859
                },
                "postalCode":"36111","state":"AL"
            },
    ...
    return (
        <div className="container d-flex flex-wrap">
            <Users_task5 user={users[0]} />
            <Users_task5 user={users[1]} />
            <Users_task5 user={users[2]} />
            <Users_task5 user={users[4]} />
            <Users_task5 user={users[5]} />
            <Users_task5 user={users[6]} />
            <Users_task5 user={users[7]} />
            <Users_task5 user={users[8]} />
            <Users_task5 user={users[9]} />
            <Users_task5 user={users[10]} />
            <Users_task5 user={users[10]} />
            <Users_task5 user={users[11]} />
            <Users_task5 user={users[12]} />
            <Users_task5 user={users[13]} />
            <Users_task5 user={users[14]} />
            <Users_task5 user={users[15]} />
            <Users_task5 user={users[16]} />
            <Users_task5 user={users[17]} />
            <Users_task5 user={users[18]} />
            <Users_task5 user={users[19]} />
            <Users_task5 user={users[20]} />
            <Users_task5 user={users[21]} />
            <Users_task5 user={users[22]} />
            <Users_task5 user={users[23]} />
            <Users_task5 user={users[24]} />
            <Users_task5 user={users[25]} />
            <Users_task5 user={users[26]} />
            <Users_task5 user={users[27]} />
            <Users_task5 user={users[28]} />
            <Users_task5 user={users[29]} />
        </div>
